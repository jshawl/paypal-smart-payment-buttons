        ...
        extraHandler: expect("GetCheckoutDetailsGQLCall", ({ data }) => {
          if (data.query.includes("query GetCheckoutDetails")) {
            if (!data.query.includes("payees")) {
              throw new Error(
                `Expected query GetCheckoutDetails to have payees`,
              );
            }
            if (!data.query.includes("merchantId")) {
              throw new Error(
                `Expected query GetCheckoutDetails to have payee merchantId`,
              );
            }
            if (!data.query.includes("email")) {
              throw new Error(
                `Expected query GetCheckoutDetails to have payee email`,
              );
            }
