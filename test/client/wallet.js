        ...
        extraHandler: ({ headers, data }) => {
          ...
          if (data.query.includes("mutation OneClickApproveOrder")) {
            if (headers["x-paypal-internal-euat"] !== accessToken) {
              throw new Error(
                `Expected buyer access token to be present in request`,
              );
            }
        ...
        extraHandler: ({ headers, data }) => {
          ...
          if (data.query.includes("mutation UpdateClientConfig")) {
            if (oneClickPayCallInProgress) {
              throw new Error(
                `Expected one click call to not be in progress during client config call`,
              );
            }
          ...
          if (data.query.includes("mutation OneClickApproveOrder")) {
            ...
            if (updateClientConfigCallInProgress) {
              throw new Error(
                `Expected client config call to not be in progress during one click call`,
              );
            }
