...
export function areObjectsIdentical(
  obj1: Breakdown | Query,
  obj2: Breakdown | Query,
): boolean {
...
export function areArraysIdentical(
  arr1: $ReadOnlyArray<Query>,
  arr2: $ReadOnlyArray<Query>,
): boolean {
