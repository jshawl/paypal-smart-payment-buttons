    ...
    return await wrapPromise(async ({ expect }) => {
      ...
      let onApprove = expect("onApprove", async (data, actions) => {
        ...
        onApprove = expect("onApprove2", async (data2) => {
          ...
          const captureOrderRESTMock2 = getRestfulCaptureOrderApiMock({
            status: 403,
          });
    ...
    return await wrapPromise(async ({ expect }) => {
      ...
      let onApprove = expect("onApprove", async (data, actions) => {
        ...
        onApprove = expect("onApprove2", async (data2) => {
          ...
          const authorizeOrderRESTMock2 = getRestfulAuthorizeOrderApiMock({
            status: 403,
          });
        ...
        const authorizeOrderRESTMock = getRestfulAuthorizeOrderApiMock({
          status: 403,
        });
