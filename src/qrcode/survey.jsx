...
|}): mixed {
  ...
  return (
    <div id="survey">
      ...
      <p class="message">
        Please let us know why. Your feedback is important to us.
      </p>
      <div class="answers">{answersElements}</div>
      <button type="button" class="continue-button" onClick={survey.disable}>
        Continue payment
      </button>
      <button type="button" class="leave-button" onClick={onCloseClick}>
        Leave
      </button>
    </div>
  );
