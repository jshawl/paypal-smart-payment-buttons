...
export function getApplePayShippingMethods(
  shippingMethods: $ReadOnlyArray<ShippingMethod> = [],
): $ReadOnlyArray<ApplePayShippingMethod> {
...
export function validateShippingContact(
  contact: ?ApplePayPaymentContact,
): ShippingContactValidation {
  ...
  const country_code: ?$Values<typeof COUNTRY> = contact?.countryCode
...
export function getShippingContactFromAddress(
