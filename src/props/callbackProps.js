...
export function getCallbackProps({
  ...
  const createBillingAgreement = getCreateBillingAgreement({
    createBillingAgreement: inputCreateBillingAgreement,
    paymentSource,
  });
  const createSubscription = getCreateSubscription(
    {
      createSubscription: inputCreateSubscription,
      partnerAttributionID,
      merchantID,
  ...
  const createVaultSetupToken = getCreateVaultSetupToken({
    createVaultSetupToken: inputCreateVaultSetupToken,
    paymentSource,
  });
  ...
  const onCancel = getOnCancel(
    { onCancel: inputOnCancel, onError },
    { createOrder },
  );
  const onShippingChange = getOnShippingChange(
    {
      onShippingChange: inputOnShippingChange,
      partnerAttributionID,
      experiments,
  ...
  const onShippingAddressChange = getOnShippingAddressChange(
    { onShippingAddressChange: inputOnShippingAddressChange },
    { createOrder },
  );
  const onShippingOptionsChange = getOnShippingOptionsChange(
    { onShippingOptionsChange: inputOnShippingOptionsChange },
    { createOrder },
  );
