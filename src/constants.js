...
export const FPTI_TRANSITION = {
  ...
  CLICK_CHOOSE_FUNDING:
    ("process_click_pay_with_different_payment_method": "process_click_pay_with_different_payment_method"),
  CLICK_CHOOSE_ACCOUNT:
    ("process_click_pay_with_different_account": "process_click_pay_with_different_account"),
  CLICK_UNLINK_ACCOUNT:
    ("process_click_unlink_account": "process_click_unlink_account"),

  INSTALLMENTS_ELIGIBLE: ("installments_eligible": "installments_eligible"),
  INSTALLMENTS_INELIGIBLE:
  ...
  RECEIVE_VAULT_SETUP_TOKEN:
    ("process_receive_vault_setup_token": "process_receive_vault_setup_token"),
  CREATE_PAYMENT: ("process_create_payment": "process_create_payment"),
  CAPTURE_AUTHORIZATION:
    ("process_capture_authorization": "process_capture_authorization"),

  CHECKOUT_SHIPPING_CHANGE:
    ("process_checkout_shipping_change": "process_checkout_shipping_change"),
  CHECKOUT_SHIPPING_ADDRESS_CHANGE:
    ("process_checkout_shipping_address_change": "process_checkout_shipping_address_change"),
  CHECKOUT_SHIPPING_OPTIONS_CHANGE:
    ("process_checkout_shipping_options_change": "process_checkout_shipping_options_change"),
  ...
  APPLEPAY_ON_CLICK_INVALID:
    ("applepay_onclick_invalid": "applepay_onclick_invalid"),
  ...
  NATIVE_APP_SWITCH_INELIGIBLE:
    ("app_switch_ineligible": "app_switch_ineligible"),
  NATIVE_ATTEMPT_APP_SWITCH: ("app_switch_attempted": "app_switch_attempted"),
  NATIVE_ATTEMPT_APP_SWITCH_ERRORED:
    ("app_switch_attempted_errored": "app_switch_attempted_errored"),
  ...
  NATIVE_POPUP_ANDROID_APP_ERROR:
    ("native_popup_android_app_installed_error": "native_popup_android_app_installed_error"),
  ...
  NATIVE_ON_SHIPPING_CHANGE:
    ("native_onshippingchange": "native_onshippingchange"),
  ...
  NATIVE_POPUP_BEFORE_UNLOAD:
    ("native_popup_beforeunload": "native_popup_beforeunload"),
  NATIVE_POPUP_PAGEHIDE: ("native_popup_pagehide": "native_popup_pagehide"),
  NATIVE_POPUP_OPENER_DETECT_CLOSE:
  ...
  QR_SURVEY:
    ("desktop_exit_survey_selection_submitted": "desktop_exit_survey_selection_submitted"),
...
export const FPTI_MENU_OPTION = {
  CHOOSE_FUNDING:
    ("pay_with_different_payment_method": "pay_with_different_payment_method"),
...
export const FPTI_CUSTOM_KEY = {
  ...
  SHIPPING_CALLBACK_INVOKED:
    ("shipping_callback_invoked": "shipping_callback_invoked"),
  DESKTOP_EXIT_SURVEY_REASON:
