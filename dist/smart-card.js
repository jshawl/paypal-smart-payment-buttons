window.smartCard = function(modules) {
    ...
    var n, l, preact_module_u, preact_module_t, preact_module_o, preact_module_r, f, c = {}, preact_module_s = [], preact_module_a = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, v = Array.isArray;
    function h(n, l) {
    ...
    function y(l, u, i) {
        ...
        return preact_module_d(l, f, t, o, null);
    }
    function preact_module_d(n, i, t, o, r) {
        var f = {
            type: n,
            props: i,
            key: t,
    ...
    function w(n) {
        (!n.__d && (n.__d = !0) && preact_module_t.push(n) && !x.__r++ || preact_module_o !== l.debounceRendering) && ((preact_module_o = l.debounceRendering) || preact_module_r)(x);
    }
    function x() {
        var n, l, u, i, o, r, e, c;
        for (preact_module_t.sort(f); n = preact_module_t.shift(); ) n.__d && (l = preact_module_t.length, 
        i = void 0, o = void 0, e = (r = (u = n).__v).__e, (c = u.__P) && (i = [], (o = h({}, r)).__v = r.__v + 1, 
        L(c, r, o, u.__n, void 0 !== c.ownerSVGElement, null != r.__h ? [ e ] : null, i, null == e ? g(r) : e, r.__h), 
        M(i, r), r.__e != e && m(r)), preact_module_t.length > l && preact_module_t.sort(f));
        x.__r = 0;
    }
    function P(n, l, u, i, t, o, r, f, e, a) {
        var h, p, y, _, b, m, w, x = i && i.__k || preact_module_s, P = x.length;
        for (u.__k = [], h = 0; h < l.length; h++) if (null != (_ = u.__k[h] = null == (_ = l[h]) || "boolean" == typeof _ || "function" == typeof _ ? null : "string" == typeof _ || "number" == typeof _ || "bigint" == typeof _ ? preact_module_d(null, _, null, null, _) : v(_) ? preact_module_d(k, {
            children: _
        }, null, null, null) : _.__b > 0 ? preact_module_d(_.type, _.props, _.key, _.ref ? _.ref : null, _.__v) : _)) {
            ...
            L(n, _, y = y || c, t, o, r, f, e, a), b = _.__e, (p = _.ref) && y.ref != p && (w || (w = []), 
            y.ref && w.push(y.ref, null, _), w.push(p, _.__c || b, _)), null != b ? (null == m && (m = b), 
            "function" == typeof _.type && _.__k === y.__k ? _.__d = e = C(_, e, n) : e = $(n, _, y, x, b, e), 
            "function" == typeof u.type && (u.__d = e)) : e && y.__e == e && e.parentNode != n && (e = g(y));
        }
        for (u.__e = m, h = P; h--; ) null != x[h] && ("function" == typeof u.type && null != x[h].__e && x[h].__e == u.__d && (u.__d = A(i).nextSibling), 
        q(x[h], x[h]));
    ...
    function T(n, l, u, i, t) {
        ...
        n.l[l + o] = u, u ? i || n.addEventListener(l, o ? z : j, o) : n.removeEventListener(l, o ? z : j, o); else if ("dangerouslySetInnerHTML" !== l) {
    ...
    function L(n, u, i, t, o, r, f, e, c) {
        ...
        try {
            n: if ("function" == typeof I) {
                if (m = u.props, w = (s = I.contextType) && t[s.__c], x = s ? w ? w.props.value : s.__ : t, 
                i.__c ? g = (a = u.__c = i.__c).__ = a.__E : ("prototype" in I && I.prototype.render ? u.__c = a = new I(m, x) : (u.__c = a = new b(m, x), 
                a.constructor = I, a.render = B), w && w.sub(a), a.props = m, a.state || (a.state = {}), 
                a.context = x, a.__n = t, p = a.__d = !0, a.__h = [], a._sb = []), null == a.__s && (a.__s = a.state), 
                null != I.getDerivedStateFromProps && (a.__s == a.state && (a.__s = h({}, a.__s)), 
                h(a.__s, I.getDerivedStateFromProps(m, a.__s))), y = a.props, d = a.state, a.__v = u, 
                p) null == I.getDerivedStateFromProps && null != a.componentWillMount && a.componentWillMount(), 
                null != a.componentDidMount && a.__h.push(a.componentDidMount); else {
                    if (null == I.getDerivedStateFromProps && m !== y && null != a.componentWillReceiveProps && a.componentWillReceiveProps(m, x), 
                    !a.__e && null != a.shouldComponentUpdate && !1 === a.shouldComponentUpdate(m, a.__s, x) || u.__v === i.__v) {
                        for (u.__v !== i.__v && (a.props = m, a.state = a.__s, a.__d = !1), a.__e = !1, 
                ...
                if (a.context = x, a.props = m, a.__P = n, S = l.__r, $ = 0, "prototype" in I && I.prototype.render) {
                    for (a.state = a.__s, a.__d = !1, S && S(u), s = a.render(a.props, a.state, a.context), 
                ...
                p || null == a.getSnapshotBeforeUpdate || (_ = a.getSnapshotBeforeUpdate(y, d)), 
                P(n, v(H = null != s && s.type === k && null == s.key ? s.props.children : s) ? H : [ H ], u, i, t, o, r, f, e, c), 
                a.base = u.__e, u.__h = null, a.__h.length && f.push(a), g && (a.__E = a.__ = null), 
                a.__e = !1;
    ...
    function N(l, u, i, t, o, r, f, e) {
        ...
        if (null == l) {
            ...
            l = o ? document.createElementNS("http://www.w3.org/2000/svg", _) : document.createElement(_, d.is && d), 
            r = null, e = !1;
        }
        if (null === _) y === d || e && l.data === d || (l.data = d); else {
            if (r = r && n.call(l.childNodes), a = (y = i.props || c).dangerouslySetInnerHTML, 
            h = d.dangerouslySetInnerHTML, !e) {
            ...
            }(l, d, y, o, e), h) u.__k = []; else if (P(l, v(k = u.props.children) ? k : [ k ], u, i, t, o && "foreignObject" !== _, r, f, r ? r[0] : i.__k && g(i, 0), e), 
            null != r) for (k = r.length; k--; ) null != r[k] && p(r[k]);
            e || ("value" in d && void 0 !== (k = d.value) && (k !== l.value || "progress" === _ && !k || "option" === _ && k !== y.value) && T(l, "value", k, y.value, !1), 
            "checked" in d && void 0 !== (k = d.checked) && k !== l.checked && T(l, "checked", k, y.checked, !1));
        }
        return l;
    }
    function O(n, u, i) {
    ...
    }, b.prototype.render = k, preact_module_t = [], preact_module_r = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, 
    f = function(n, l) {
    ...
    var createVaultSetupToken_getCreateVaultSetupToken = function(_ref) {
        ...
        if (createVaultSetupToken) return memoize((function() {
    ...
    function getCreateOrder(_ref) {
        ...
        if (createOrder) return memoize((function() {
            return promise_ZalgoPromise.try((function() {
                return createOrder();
    ...
    function getCardProps(_ref) {
        ...
        return _extends({}, baseProps, returnData, {
                ...
                return cardProps.createOrder().then((function(id) {
                    ...
                    return function(orderID, data, _ref11) {
                        ...
                        return function(_ref) {
                            ...
                            url: "/v2/checkout/orders/" + orderID + "/confirm-payment-source",
                            data: data,
    ...
    function CardNumber(_ref2) {
        ...
        var _useState4 = hooks_module_h(_extends({}, defaultInputState, state)), inputState = _useState4[0], setInputState = _useState4[1];
        ...
        return y(k, null, y("input", _extends({
    ...
    function CardExpiry(_ref) {
        ...
        var _useState2 = hooks_module_h(_extends({}, defaultInputState, state)), inputState = _useState2[0], setInputState = _useState2[1];
    ...
    function Page(_ref) {
        ...
        return y(k, null, "single" === type ? y(CardField, {
    ...
    function setupCard(_ref6) {
        ...
        !function(_ref) {
            ...
            logger.addTrackingBuilder((function() {
                var _ref2;
                return (_ref2 = {}).button_version = "5.0.143", _ref2.hcf_session_id = hcfSessionID, 
        ...
        !function(u, i, t) {
            var r, f;
            l.__ && l.__(u, i), r = !1 ? null : i.__k, f = [], L(i, u = i.__k = y(k, null, [ u ]), r || c, c, void 0 !== i.ownerSVGElement, r ? null : i.firstChild ? n.call(i.childNodes) : null, f, r ? r.__e : i.firstChild, !1), 
            M(f, u);
        }(y(Page, {
            cspNonce: cspNonce,
            props: props,
