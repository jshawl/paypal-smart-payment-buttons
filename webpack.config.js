...
export const WEBPACK_CONFIG_BUTTONS_DEBUG: WebpackConfig =
  getSmartWebpackConfig({
    modulename: "spb",
    entry: "src/button",
    filename: "smart-payment-buttons",
    debug: true,
...
export const WEBPACK_CONFIG_BUTTONS_LOCAL_DEBUG: WebpackConfig =
  getSmartWebpackConfig({
    modulename: "spb",
    env: "local",
    entry: "src/button",
...
export const WEBPACK_CONFIG_NATIVE_POPUP_MIN: WebpackConfig =
  getSmartWebpackConfig({
    modulename: "spbNativePopup",
    entry: "src/native/popup",
    filename: "smart-native-popup",
...
export const WEBPACK_CONFIG_NATIVE_POPUP_DEBUG: WebpackConfig =
  getSmartWebpackConfig({
    modulename: "spbNativePopup",
    entry: "src/native/popup",
    filename: "smart-native-popup",
...
export const WEBPACK_CONFIG_NATIVE_FALLBACK: WebpackConfig =
  getSmartWebpackConfig({
...
export const WEBPACK_CONFIG_NATIVE_FALLBACK_MIN: WebpackConfig =
  getSmartWebpackConfig({
    modulename: "spbNativeFallback",
    entry: "src/native/fallback",
    filename: "smart-native-fallback",
...
export const WEBPACK_CONFIG_NATIVE_FALLBACK_DEBUG: WebpackConfig =
  getSmartWebpackConfig({
    modulename: "spbNativeFallback",
    entry: "src/native/fallback",
    filename: "smart-native-fallback",
